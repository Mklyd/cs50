...
class Ui_MovieMainWindow(object):
    def setup_ui(self, movie_main_window):
        ...
        movie_main_window.resize(400, 220)                        # 400
        movie_main_window.setMinimumSize(QtCore.QSize(400, 220))  # 400
        movie_main_window.setMaximumSize(QtCore.QSize(400, 220))  # 400
        icon = QtGui.QIcon()
